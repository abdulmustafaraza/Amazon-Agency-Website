...
export const siteContent: SiteContent = {
  ...
  hero: {
    ...
    supportingCopy:
      "CompanyName helps DTC ecommerce brands uncover marketplace leakage, reduce customer confusion, and build a controlled Amazon presence when the channel makes strategic sense.",
    secondaryCopy:
